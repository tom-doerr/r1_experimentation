...
xml_data: str = '<response><message>hello</message></response>'
...
# don't mock
completion: str = litellm_completion('hi', model=MODEL)
print("completion:", completion)

reply_generator: Generator[str, None, None] = litellm_streaming('hi')
...
reply_generator: Generator[str, None, None] = litellm_streaming('hi', model=OR1, max_tokens=40)
print("reply_generator:", reply_generator)
for reply in reply_generator:
    print("-", reply, end='')
...
agent.update_memory(parsed_data_2['memory']['replace'])
...
bool_val: bool = agent_assert('<response><message>The implementation does not match specifications</message><bool>False</bool></response>')
